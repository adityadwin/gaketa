          ...
          <article className="flex-1">
            ...
            <h1 className="mt-4 font-roboto text-xl font-medium text-dark-hard md:text-[26px]">
              <input
                ...
                placeholder="Title"
                className="w-full rounded-lg border border-gray-300 py-2 px-3 text-xl font-medium text-dark-hard focus:outline-none focus:ring focus:ring-primary"
              />
            </h1>
            ...
            <textarea
              ...
              placeholder="Caption"
              className="h-32 w-full rounded-lg border border-gray-300 py-2 px-3 focus:outline-none focus:ring focus:ring-primary"
            ></textarea>
            <button
