...
import ArticleDetailSkeleton from "./components/GaketaDetailSkeleton";
...
const ArticleDetailPage = () => {
  ...
  const { data, isLoading, isError } = useQuery({
    ...
    onSuccess: (data) => {
      ...
      setbreadCrumbsData([
        { name: "Home", link: "/" },
        { name: "Post Detail", link: `/blog/${data.slug}` },
      ]);
      ...
      {isLoading ? (
        ...
        <section className="container mx-auto flex max-w-5xl flex-col px-5 py-5 lg:flex-row lg:items-start lg:gap-x-5">
          <article className="flex-1">
            ...
            <h1 className="mt-4 font-roboto text-xl font-semibold text-dark-hard md:text-[26px] lg:text-3xl">
              {data?.title}
            </h1>
