...
const GaketaCard = ({ post, className }) => {
  return (
    <div
      className={`overflow-hidden rounded-xl bg-[#FEFAE0] shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] ${className}`}
    >
      ...
      <div className="p-5">
        <Link to={`/blog/${post.slug}`}>
          ...
          <p
            className="mt-3 text-sm text-dark-light md:text-lg"
            style={{
        ...
        <div className="mt-6 flex flex-nowrap items-center justify-between">
          ...
          <span className="text-sm font-semibold italic text-dark-hard md:text-base">
